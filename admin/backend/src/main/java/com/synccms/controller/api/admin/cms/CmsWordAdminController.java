...
import com.synccms.entities.cms.CmsWord;
...
import com.synccms.logic.service.cms.CmsWordService;
...
public class CmsWordAdminController {
    ...
    @RequestMapping("save")
    @Csrf
    public String save(@RequestAttribute SysSite site, @SessionAttribute BaseSysUser admin, CmsWord entity,
    ...
    @Csrf
    public String delete(@RequestAttribute SysSite site, @SessionAttribute BaseSysUser admin, Long id, HttpServletRequest request,
                         ModelMap model) {
    ...
    @Csrf
    public String hidden(@RequestAttribute SysSite site, @SessionAttribute BaseSysUser admin, Long id, HttpServletRequest request,
                         ModelMap model) {
        CmsWord entity = service.getEntity(id);
        if (null != entity) {
            if (ControllerUtils.verifyNotEquals("siteId", site.getId(), entity.getSiteId(), model)) {
    ...
    @RequestMapping("show")
    @Csrf
    public String show(@RequestAttribute SysSite site, @SessionAttribute BaseSysUser admin, Long id, HttpServletRequest request,
                       ModelMap model) {
        CmsWord entity = service.getEntity(id);
        if (null != entity) {
            if (ControllerUtils.verifyNotEquals("siteId", site.getId(), entity.getSiteId(), model)) {
